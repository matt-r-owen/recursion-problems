...
function deepDup(array) {
  if (typeof array !== "object") {  // This is the base case.  If the input array is no longer an object, and instead is a primative like a string or number, then stop recursively looping through the function.
    return array;
  }
